    ...
    <div className="absolute inset-0 min-w-[200vw] min-h-[200vh] pointer-events-none overflow-hidden">
      ...
      <svg className="absolute inset-0 min-w-[200vw] min-h-[200vh]" preserveAspectRatio="none">
        ...
        {[
          ...
          // More flowers as requested
          { x: 450, y: 150 }, { x: 750, y: 250 }, { x: 100, y: 400 }, { x: 1300, y: 600 },
          { x: 1600, y: 150 }, { x: 1900, y: 750 }, { x: 2200, y: 950 }, { x: 2500, y: 450 },
          { x: 300, y: 1000 }, { x: 600, y: 1300 }, { x: 900, y: 1600 }, { x: 1200, y: 100 },
          { x: 1500, y: 1800 }, { x: 1800, y: 1100 }, { x: 2100, y: 1400 }, { x: 2400, y: 1700 },
          { x: 100, y: 1900 }, { x: 400, y: 2100 }, { x: 700, y: 1950 }, { x: 1000, y: 2150 },
        ].map((pos, i) => (
          <g key={`flower-${i}`}>
            {i % 3 === 0 ? (
              // Small flower
